...
REGISTER_DRIVER(sp804_periodic_timer, "sp804,periodic-timer", periodic_timer_init);
REGISTER_DRIVER(sp804_clocksource_timer, "sp804,clocksource-timer", clocksource_timer_init);
